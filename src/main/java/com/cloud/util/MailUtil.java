...
public class MailUtil {
	...
	public boolean sendMail(List<String> to,String subject,String body,List<String> filepath){
		return sendMail(username,password,nick,to,subject,body,filepath);
	}
	
	public boolean sendMail(String username,String password,String nickName,List<String> to,String subject,String body,List<String> filepath){
		try {
			if(body == null){
				body = "";
			}
