					...
					<div class="row">
						<div class="col-xs-12">
							<h3 class="header smaller lighter blue">
								<span>项目列表</span><button class="btn" style="float:right;margin-top: -12px;" onclick="go_url('../project/addinit')" ><i class="icon-pencil align-top bigger-125"></i>项目新增</button>
							</h3>
											...
											<tr>
												...
												<td>
													<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
														...
														<a class="green" href="../project/updateInit?id=${p.id}">
													...
													<div class="visible-xs visible-sm hidden-md hidden-lg">
														<div class="inline position-relative">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																...
																<li>
																	<a href="../project/updateInit?id=${p.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="green">
							...
							<div class="modal-footer no-margin-top">
								<ul class="pagination pull-right no-margin" id="page">
									...
									<c:forEach items="${pu.pageList}" var="p">
										...
										<c:if test="${p!=pu.page}">
											<li>
												<a href="../project/list?page=${p}">${p}</a>
											</li>
										</c:if>
									</c:forEach>
									...
									<c:if test="${pu.page!=pu.pageCount}">
										<li class="next">
											<a href="../project/list?page=${pu.pageCount}">
												<i class="icon-double-angle-right"></i>
											</a>
										</li>
									</c:if>
