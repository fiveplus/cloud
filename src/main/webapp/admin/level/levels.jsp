						...
						<div class="col-xs-12">
													...
													<div class="visible-xs visible-sm hidden-md hidden-lg">
														<div class="inline position-relative">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																...
																<li>
																	<a href="javascript:del_level(${l.id})" class="tooltip-error" data-rel="tooltip" title="Delete">
																		<span class="red">
							...
							<div class="modal-footer no-margin-top">
								<ul class="pagination pull-right no-margin" id="page">
									...
									<c:if test="${pu.page!=1}">
										<li class="prev">
											<a href="${contextPath}/admin/level/list?page=1">
												<i class="icon-double-angle-left"></i>
											</a>
										</li>
									</c:if>
									<c:forEach items="${pu.pageList}" var="p">
										...
										<c:if test="${p!=pu.page}">
											<li>
												<a href="${contextPath}/admin/level/list?page=${p}">${p}</a>
											</li>
										</c:if>
									</c:forEach>
									...
									<c:if test="${pu.page!=pu.pageCount}">
										<li class="next">
											<a href="${contextPath}/admin/level/list?page=${pu.pageCount}">
												<i class="icon-double-angle-right"></i>
											</a>
										</li>
									</c:if>
		...
		<script type="text/javascript">
			function del_level(id){
				bootbox.confirm("确认删除?",function(result){
					if(result){
						$.ajax({
							url:'${contextPath}/admin/level/delete.json',
							data:{id:id},
							dataType:"json",
