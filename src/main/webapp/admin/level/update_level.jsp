		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							<form action="${contextPath}/admin/level/update.json" role="form" class="form-horizontal" method="post" id="form_post" >
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 请输入职位级别名称 </label>
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="职位级别名称" class="col-xs-10 col-sm-5" name="name" value="${level.name}" />
									</div>
								</div>
								<div class="space-4"></div>
								...
								<div class="form-group" >
									...
									<div class="wysiwyg-editor" id="editor1" >${level.info}</div>
									<input type="hidden" name="info" value="${level.info}" />
								</div>
								<div class="space-4"></div>
