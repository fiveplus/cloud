	...
	<fms:Content contentPlaceHolderId="main">
		...
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<div class="nav-search" id="nav-search">
				<form action="" method="post" onsubmit="return false;" action="" method="post" onsubmit="return false;" class="form-search">
										...
										<tr>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="red" href="javascript:del_permission('${p.id}')">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
															...
															<li>
																<a href="javascript:del_permission('${p.id}')" class="tooltip-error" data-rel="tooltip" title="Delete">
																	<span class="red">
		...
		<script type="text/javascript">
			function del_permission(id){
				bootbox.confirm("确认删除?",function(result){
					if(result){
						$.ajax({
							url:'${contextPath}/admin/permission/delete.json',
							data:{id:id},
							dataType:"json",
